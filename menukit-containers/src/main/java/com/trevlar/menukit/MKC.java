 ...
 * <ul>
 *   <li><b>Screens:</b> {@code com.trevlar.menukit.screen.MKCScreenHandler}
 *       + {@code MKCHandledScreen}</li>
 *   <li><b>Slot composition:</b> {@code com.trevlar.menukit.core.SlotGroup},
 *       {@code SlotGroupLike}</li>
 *   <li><b>Observed screens:</b> {@code HandlerRecognizerRegistry},
 *       {@code VirtualSlotGroup}</li>
 *   <li><b>State persistence:</b> {@code com.trevlar.menukit.core.MKSlotState},
 *       {@code com.trevlar.menukit.core.StorageAttachment}</li>
 * </ul>
 */
@ApiStatus.Internal
public class MKC implements ModInitializer {
    ...
    public static void init() {
        ...
        com.trevlar.menukit.state.SlotStateAttachments.register();
        // M1 block-portable bridge component (§0048) — must register on both
        // sides for data-component registry consistency.
        com.trevlar.menukit.state.SlotStateComponents.register();
        com.trevlar.menukit.state.SlotStateHooks.registerCommon();
        com.trevlar.menukit.state.SlotStateHooks.registerServer();
        ...
        net.fabricmc.fabric.api.networking.v1.PayloadTypeRegistry.serverboundPlay().register(
                com.trevlar.menukit.network.MKCOpenMenuC2SPayload.TYPE,
                com.trevlar.menukit.network.MKCOpenMenuC2SPayload.STREAM_CODEC);
        net.fabricmc.fabric.api.networking.v1.ServerPlayNetworking.registerGlobalReceiver(
                com.trevlar.menukit.network.MKCOpenMenuC2SPayload.TYPE,
                (payload, context) -> {
                    net.minecraft.server.level.ServerPlayer player = context.player();
                    com.trevlar.menukit.screen.MKCMenu handle =
                            com.trevlar.menukit.screen.MKCMenu.byId(payload.menuId());
                    if (handle == null) {
        ...
        if (net.fabricmc.loader.api.FabricLoader.getInstance().isModLoaded("universal-graves")) {
            com.trevlar.menukit.compat.UniversalGravesAdapter.register();
    ...
    public static void initClient() {
        ...
        com.trevlar.menukit.state.SlotStateHooks.registerClient();
    }
}
