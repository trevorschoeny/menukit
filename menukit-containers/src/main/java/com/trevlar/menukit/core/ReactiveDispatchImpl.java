...
import com.trevlar.menukit.window.ReactEvent;
import com.trevlar.menukit.window.ReactiveDispatch;
import com.trevlar.menukit.window.ReactiveHook;
 ...
 * the {@link com.trevlar.menukit.window.ReactionGuard re-entrancy bound};
 * the firing seam (owed, per menu type) calls
 * {@link com.trevlar.menukit.window.WindowReactions#fireInsert}/{@code fireTake}
