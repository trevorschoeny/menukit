package com.trevlar.menukit.core.attachment;
...
import com.trevlar.menukit.core.DropRule;
...
public final class StorageAttachments {
     ...
     * {@link com.trevlar.menukit.core.StorageAttachment#playerAttached(String, String, int)}.
     */
     ...
     * against. Called by
     * {@link com.trevlar.menukit.core.StorageAttachment#blockScoped(String, String, int)}.
     */
