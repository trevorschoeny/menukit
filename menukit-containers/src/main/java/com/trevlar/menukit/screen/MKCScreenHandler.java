package com.trevlar.menukit.screen;
...
public class MKCScreenHandler extends AbstractContainerMenu implements PanelOwner {
     ...
     *
     * A created slot's {@link com.trevlar.menukit.window.Address} is global, keyed
     * by {@code (panelId, groupId, localIndex)} — NOT scoped by the owning
     * {@link com.trevlar.menukit.screen.MKCMenu}'s {@code Identifier}. So two
    ...
    public static class PanelBuilder {
        ...
        /**
         * Adds a standalone {@link com.trevlar.menukit.core.InfoBox}
         ...
         * (an {@link com.trevlar.menukit.core.AbstractPanelElement}), which
        ...
        public PanelBuilder tooltip(
            ...
            if (last instanceof com.trevlar.menukit.core.AbstractPanelElement<?> ape) {
