...
public final class ScreenPanelAdapter {
     ...
     *  (the panel's {@link com.trevlar.menukit.core.PanelPosition.Mode#PIXEL}
     ...
     * panel must declare {@link com.trevlar.menukit.core.PanelPosition#pixel}:
    ...
    public ScreenPanelAdapter(Panel panel, int padding) {
        if (panel.getPosition().mode()
                != com.trevlar.menukit.core.PanelPosition.Mode.PIXEL) {
    ...
    public void render(GuiGraphicsExtractor graphics, ScreenBounds screenBounds,
        ...
        com.trevlar.menukit.core.PanelDispatch.renderElements(panel, ctx);
     ...
     * Canonical consumer: an open {@link com.trevlar.menukit.core.Dropdown}.
     */
