...
public final class PanelLayout {
    ...
    public static Map<String, PanelBounds> resolve(
        ...
        for (Panel panel : panels) {
            ...
            // Overlay-positioned panels (PanelPosition.center(), or any
            // dimsBehind/tracksAsModal panel) are positioned independently of
            // the body stack by the screen's render layer (auto-centered on
            // screen). They must not contribute layout space here, or
            // visibility-toggling an overlay would shift the underlying body
            // stack. Skip them.
