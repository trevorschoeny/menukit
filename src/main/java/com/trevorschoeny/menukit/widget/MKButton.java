...
import com.trevorschoeny.menukit.event.MKUIEvent;
...
public class MKButton extends AbstractButton {
    ...
    public @Nullable MKContext eventContext;

    /** The player for event dispatch. Set during button creation. */
    public net.minecraft.world.entity.player.@Nullable Player eventPlayer;
